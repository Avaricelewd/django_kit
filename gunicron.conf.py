...
bind = "192.168.119.10:8000"   #绑定的ip与端口    ip改成自己的电脑ip
backlog = 32                #监听队列数量，64-2048   根据使用的人数修改
#chdir = '/home/testrver/bin'  #gunicorn要切换到的目的工作目录
worker_class = 'sync' #使用gevent模式，还可以使用sync 模式，默认的是sync模式
workers = 4 # multiprocessing.cpu_count()    #进程数
threads = 32 #multiprocessing.cpu_count()*4 #指定每个进程开启的线程数
